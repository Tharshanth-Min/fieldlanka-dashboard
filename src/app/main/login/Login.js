...
function Login() {
	...
	return (
		<div
			className={clsx(
				classes.root,
				'flex flex-col flex-auto items-center justify-center flex-shrink-0 p-18 md:p-24'
			)}
		>
								...
								<Tab
									icon={
										<img
											...
											src="assets/images/logos/fieldlanka.png"
											alt="firebase"
										/>
									}
									className="min-w-0"
					...
					<div className={clsx(classes.rightSection, 'hidden md:flex flex-1 items-center justify-center p-64')}>
						<div className="max-w-320">
							<FuseAnimate animation="transition.slideUpIn" delay={400}>
								<Typography variant="h5" color="inherit" className="font-800 leading-tight">
									Field Lanka
								</Typography>
							</FuseAnimate>
